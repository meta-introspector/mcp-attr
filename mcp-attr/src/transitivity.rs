...
impl ::std::convert::From<ResourceLink> for GetPromptResult {
    fn from(value: ResourceLink) -> Self {
        <GetPromptResult as ::std::convert::From<PromptMessage>>::from(
            <PromptMessage as ::std::convert::From<ResourceLink>>::from(value),
        )
    }
}
impl ::std::convert::From<ResourceLink> for ServerResult {
    fn from(value: ResourceLink) -> Self {
        <ServerResult as ::std::convert::From<CallToolResult>>::from(
            <CallToolResult as ::std::convert::From<ResourceLink>>::from(value),
        )
    }
}
impl ::std::convert::From<ResourceLink> for PromptMessage {
    fn from(value: ResourceLink) -> Self {
        <PromptMessage as ::std::convert::From<ContentBlock>>::from(
            <ContentBlock as ::std::convert::From<ResourceLink>>::from(value),
        )
    }
}
impl ::std::convert::From<ResourceLink> for CallToolResult {
    fn from(value: ResourceLink) -> Self {
        <CallToolResult as ::std::convert::From<ContentBlock>>::from(
            <ContentBlock as ::std::convert::From<ResourceLink>>::from(value),
        )
    }
}
...
impl ::std::convert::From<Vec<ResourceTemplate>> for ServerResult {
    fn from(value: Vec<ResourceTemplate>) -> Self {
        <ServerResult as ::std::convert::From<ListResourceTemplatesResult>>::from(
            <ListResourceTemplatesResult as ::std::convert::From<Vec<ResourceTemplate>>>::from(
                value,
            ),
        )
    }
...
impl ::std::convert::From<&ResourceTemplateReference> for CompleteRequestParamsRef {
    fn from(value: &ResourceTemplateReference) -> Self {
        <CompleteRequestParamsRef as ::std::convert::From<ResourceTemplateReference>>::from(
            <ResourceTemplateReference as ::std::convert::From<&ResourceTemplateReference>>::from(
                value,
            ),
        )
    }
...
impl ::std::convert::From<ContentBlock> for GetPromptResult {
    fn from(value: ContentBlock) -> Self {
        <GetPromptResult as ::std::convert::From<PromptMessage>>::from(
            <PromptMessage as ::std::convert::From<ContentBlock>>::from(value),
        )
    }
}
impl ::std::convert::From<ContentBlock> for ServerResult {
    fn from(value: ContentBlock) -> Self {
        <ServerResult as ::std::convert::From<CallToolResult>>::from(
            <CallToolResult as ::std::convert::From<ContentBlock>>::from(value),
        )
    }
}
...
impl ::std::convert::From<&ImageContent> for ContentBlock {
    fn from(value: &ImageContent) -> Self {
        <ContentBlock as ::std::convert::From<ImageContent>>::from(
...
impl ::std::convert::From<&ImageContent> for CallToolResult {
    fn from(value: &ImageContent) -> Self {
        <CallToolResult as ::std::convert::From<ContentBlock>>::from(
            <ContentBlock as ::std::convert::From<&ImageContent>>::from(value),
        )
    }
}
...
impl ::std::convert::From<&TextContent> for CallToolResult {
    fn from(value: &TextContent) -> Self {
        <CallToolResult as ::std::convert::From<ContentBlock>>::from(
            <ContentBlock as ::std::convert::From<&TextContent>>::from(value),
        )
    }
}
impl ::std::convert::From<&TextContent> for ContentBlock {
    fn from(value: &TextContent) -> Self {
        <ContentBlock as ::std::convert::From<TextContent>>::from(
            <TextContent as ::std::convert::From<&TextContent>>::from(value),
        )
    }
}
...
impl ::std::convert::From<&EmbeddedResource> for CallToolResult {
    fn from(value: &EmbeddedResource) -> Self {
        <CallToolResult as ::std::convert::From<ContentBlock>>::from(
            <ContentBlock as ::std::convert::From<&EmbeddedResource>>::from(value),
        )
    }
}
impl ::std::convert::From<&EmbeddedResource> for ContentBlock {
    fn from(value: &EmbeddedResource) -> Self {
        <ContentBlock as ::std::convert::From<EmbeddedResource>>::from(
...
impl ::std::convert::From<&JsonrpcResponse> for JsonrpcMessage {
    fn from(value: &JsonrpcResponse) -> Self {
        <JsonrpcMessage as ::std::convert::From<JsonrpcResponse>>::from(
...
impl ::std::convert::From<&ListResourceTemplatesRequest> for ClientRequest {
    fn from(value: &ListResourceTemplatesRequest) -> Self {
        < ClientRequest as :: std :: convert :: From < ListResourceTemplatesRequest >> :: from (< ListResourceTemplatesRequest as :: std :: convert :: From < & ListResourceTemplatesRequest >> :: from (value))
    }
}
...
impl ::std::convert::From<&AudioContent> for ContentBlock {
    fn from(value: &AudioContent) -> Self {
        <ContentBlock as ::std::convert::From<AudioContent>>::from(
            <AudioContent as ::std::convert::From<&AudioContent>>::from(value),
        )
    }
}
...
impl ::std::convert::From<&AudioContent> for CallToolResult {
    fn from(value: &AudioContent) -> Self {
        <CallToolResult as ::std::convert::From<ContentBlock>>::from(
            <ContentBlock as ::std::convert::From<&AudioContent>>::from(value),
        )
    }
}
...
impl ::std::convert::From<&str> for PromptMessage {
    fn from(value: &str) -> Self {
        <PromptMessage as ::std::convert::From<ContentBlock>>::from(
            <ContentBlock as ::std::convert::From<&str>>::from(value),
        )
    }
}
impl ::std::convert::From<&str> for ContentBlock {
    fn from(value: &str) -> Self {
        <ContentBlock as ::std::convert::From<TextContent>>::from(
            <TextContent as ::std::convert::From<&str>>::from(value),
        )
...
impl ::std::convert::From<&ContentBlock> for CallToolResult {
    fn from(value: &ContentBlock) -> Self {
        <CallToolResult as ::std::convert::From<ContentBlock>>::from(
            <ContentBlock as ::std::convert::From<&ContentBlock>>::from(value),
        )
    }
}
impl ::std::convert::From<&ContentBlock> for GetPromptResult {
...
impl ::std::convert::From<&ContentBlock> for PromptMessage {
    fn from(value: &ContentBlock) -> Self {
        <PromptMessage as ::std::convert::From<ContentBlock>>::from(
            <ContentBlock as ::std::convert::From<&ContentBlock>>::from(value),
        )
...
impl ::std::convert::From<&ElicitResult> for ClientResult {
    fn from(value: &ElicitResult) -> Self {
        <ClientResult as ::std::convert::From<ElicitResult>>::from(
            <ElicitResult as ::std::convert::From<&ElicitResult>>::from(value),
        )
    }
}
impl ::std::convert::From<PromptMessage> for ServerResult {
...
impl ::std::convert::From<&JsonrpcError> for JsonrpcMessage {
    fn from(value: &JsonrpcError) -> Self {
        <JsonrpcMessage as ::std::convert::From<JsonrpcError>>::from(
...
impl ::std::convert::From<&ElicitRequest> for ServerRequest {
    fn from(value: &ElicitRequest) -> Self {
        <ServerRequest as ::std::convert::From<ElicitRequest>>::from(
            <ElicitRequest as ::std::convert::From<&ElicitRequest>>::from(value),
        )
    }
}
impl ::std::convert::From<&ResourceLink> for ContentBlock {
    fn from(value: &ResourceLink) -> Self {
        <ContentBlock as ::std::convert::From<ResourceLink>>::from(
            <ResourceLink as ::std::convert::From<&ResourceLink>>::from(value),
        )
    }
}
impl ::std::convert::From<&ResourceLink> for PromptMessage {
...
impl ::std::convert::From<&ListResourceTemplatesResult> for ServerResult {
    fn from(value: &ListResourceTemplatesResult) -> Self {
        < ServerResult as :: std :: convert :: From < ListResourceTemplatesResult >> :: from (< ListResourceTemplatesResult as :: std :: convert :: From < & ListResourceTemplatesResult >> :: from (value))
    }
}
...
impl ::std::convert::From<&JsonrpcRequest> for JsonrpcMessage {
    fn from(value: &JsonrpcRequest) -> Self {
        <JsonrpcMessage as ::std::convert::From<JsonrpcRequest>>::from(
...
impl ::std::convert::From<&JsonrpcNotification> for JsonrpcMessage {
    fn from(value: &JsonrpcNotification) -> Self {
        <JsonrpcMessage as ::std::convert::From<JsonrpcNotification>>::from(
...
impl ::std::convert::From<String> for ContentBlock {
    fn from(value: String) -> Self {
        <ContentBlock as ::std::convert::From<TextContent>>::from(
...
impl ::std::convert::From<String> for PromptMessage {
    fn from(value: String) -> Self {
        <PromptMessage as ::std::convert::From<ContentBlock>>::from(
            <ContentBlock as ::std::convert::From<String>>::from(value),
        )
    }
}
